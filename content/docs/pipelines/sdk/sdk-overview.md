...
* [KFP diagnose_me modules](https://github.com/kubeflow/pipelines/tree/master/sdk/python/kfp/cli/diagnose_me)
  These modules are part of the KFP CLI tool that are designed to help with enviroment diagnostic tasks such as 
...
## KFP CLI Tool 
Kubeflow pipelines has a CLI tool that enables a subset of the sdk functionalriity directly from a command line in addition to enviroment diagnostic features. In particular the CLI tool provides the following features: 
